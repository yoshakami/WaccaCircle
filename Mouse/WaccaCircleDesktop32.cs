...
class Program
{
    ...
    static void Main()
    {
        ...
        Thread.Sleep(1000);
        int[] hours_x = { 540, 770, 938, 1000, 938, 770, 540, 310, 141, 80, 141, 309, 540, 700, 817, 860, 817, 700, 540, 380, 262, 220, 262, 379, 607, 709, 712, 613, 472, 370, 367, 466 };
        int[] hours_y = { 447, 508, 677, 907, 1137, 1305, 1367, 1305, 1137, 907, 677, 508, 587, 629, 747, 907, 1067, 1184, 1227, 1184, 1067, 907, 747, 629, 734, 833, 974, 1076, 1079, 980, 839, 737 };
        int x;
        int y;
        x = 150;
        y = 650;
