    ...
    internal class WaccaCircleOsu
    {
        ...
        joystick.SetBtn(false, deviceId, 1); // Release button 1
            ...
            {      //  osu  x axis    y-axis   1-12  13-16  17-20  21-22  23-24  25-32
                ...
                new int[] { X(8.5),   Y(8.5),   10,   16,    17,    21,    23,    26},    // 8
                new int[] { X(9.5),   Y(9.5),   10,   16,    17,    21,    23,    26},    // 9
                new int[] { X(10.5),  Y(10.5),  10,   16,    17,    21,    23,    26},    // 10
                new int[] { X(11.5),  Y(11.5),  10,   16,    17,    21,    23,    26},    // 11
                new int[] { X(12.5),  Y(12.5),  10,   16,    17,    21,    23,    26},    // 12
                new int[] { X(13.5),  Y(13.5),   9,   16,    17,    21,    23,    26},    // 13
                new int[] { X(14.5),  Y(14.5),   9,   16,    20,    21,    23,    26},    // 14  left
                new int[] { X(15.5),  Y(15.5),   9,   15,    20,    22,    23,    26},    // 15  left 
                new int[] { X(16.5),  Y(16.5),   9,   15,    19,    22,    23,    27},    // 16
                new int[] { X(17.5),  Y(17.5),   9,   15,    19,    22,    23,    27},    // 17
                new int[] { X(18.5),  Y(18.5),   8,   15,    19,    22,    23,    27},    // 18
                new int[] { X(19.5),  Y(19.5),   8,   15,    19,    22,    23,    27},    // 19
                new int[] { X(20.5),  Y(20.5),   8,   15,    19,    22,    23,    27},    // 20
                new int[] { X(21.5),  Y(21.5),   8,   15,    19,    22,    23,    27},    // 21
                new int[] { X(22.5),  Y(22.5),   8,   15,    19,    22,    23,    27},    // 22
                ...
                new int[] { X(38.5),  Y(38.5),   4,   14,    19,    22,    24,    30},    // 38
                new int[] { X(39.5),  Y(39.5),   4,   14,    19,    22,    24,    30},    // 39
                new int[] { X(40.5),  Y(40.5),   4,   14,    19,    22,    24,    30},    // 40
                new int[] { X(41.5),  Y(41.5),   4,   14,    19,    22,    24,    30},    // 41
                new int[] { X(42.5),  Y(42.5),   4,   14,    19,    22,    24,    30},    // 42
                new int[] { X(43.5),  Y(43.5),   3,   14,    19,    22,    24,    30},    // 43
                new int[] { X(44.5),  Y(44.5),   3,   14,    18,    22,    24,    31},    // 44  right
                new int[] { X(45.5),  Y(45.5),   3,   13,    18,    21,    24,    31},    // 45  right
                new int[] { X(46.5),  Y(46.5),   3,   13,    17,    21,    24,    31},    // 46
                new int[] { X(47.5),  Y(47.5),   3,   13,    17,    21,    24,    31},    // 47
                new int[] { X(48.5),  Y(48.5),   2,   13,    17,    21,    24,    31},    // 48
                new int[] { X(49.5),  Y(49.5),   2,   13,    17,    21,    24,    31},    // 49
                new int[] { X(50.5),  Y(50.5),   2,   13,    17,    21,    24,    31},    // 50
                new int[] { X(51.5),  Y(51.5),   2,   13,    17,    21,    24,    31},    // 51
                new int[] { X(52.5),  Y(52.5),   2,   13,    17,    21,    24,    32},    // 52
